...
public class RequestsFragment extends Fragment {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (type.equals("received")) {
                                        ...
                                        TextView request_sent_btn = holder.itemView.findViewById(R.id.request_accept_btn);
                                        request_sent_btn.setText("Requested");
                                        request_sent_btn.setTextColor(getResources().getColor(android.R.color.darker_gray));
    ...
    public static class RequestsViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView AcceptButton, CancelButton;
